    ...
    <div class="container-fluid">
      <div class="col-xs-12">
        <a title="${message("site.company")}" href="http://thl.fi/[#if lang!="fi"]${lang}/web/thlfi-${lang}[/#if]">
          <img class="footer-logo" src="${rc.contextPath}/images/THL.svg" alt="${message('site.thl.logo.alt')}">
        </a>
      </div>
...
<html lang="${lang!'fi'}">
    ...
    <div id="skip-to-content" class="skip-to-content">
      ...
      <header role="banner" class="summary-header container-fluid">
          <div class="logo">
              <img src="${rc.contextPath}/images/THL_tunnus_pitka_${lang}_RGB.svg" alt="${message('site.thl.logo.alt')}">
          </div>
