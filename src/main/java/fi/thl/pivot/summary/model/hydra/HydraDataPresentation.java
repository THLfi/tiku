...
import fi.thl.pivot.summary.model.MeasureItem;
...
public class HydraDataPresentation extends DataPresentation {
    ...
    private final Logger logger = LoggerFactory.getLogger(HydraDataPresentation.class);
    ...
    public boolean isValid() {
        try {
            ...
            logger.warn("Invalid presentation " + e.getMessage());
            return false;
        }
    }
